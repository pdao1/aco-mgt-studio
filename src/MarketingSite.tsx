...
export default function MarketingSite() {
  ...
  return (
    <main className="marketing-shell">
      ...
      <section className="product-offerings" aria-label="Choose your product"><article><h2>For Solo Buyers</h2><p>Buy Pokémon online? Connect your own inboxes and follow all your purchases, items, and shipments in a private personal dashboard.</p><a className="primary-action" href="/customer">Track my orders <ArrowRight size={16}/></a></article><article><h2>For ACOs</h2><p>Manage your customers, share a private order view with each of them, and invoice your service fees from your company workspace.</p><a className="secondary-action" href="/app">Open customer workspace <ArrowRight size={16}/></a></article></section>
